  ...
  async function handleSubmit(
    ...
    if (form.maxBookings) {
      ...
      if (
        ...
        setError(
          "Maximum bookings must be a positive number."
        );
        return;
      }
    }
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-white/50">
            {mode === "edit"
              ? "Update your hotel deal information."
              : "Create a special offer for one of your hotels."}
          </p>
        </div>
        ...
        >
            ...
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <div className="md:col-span-2">
                ...
                <select
                  ...
                  className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm outline-none transition focus:border-[#D4AF37]/50"
                >
                  <option
                    value=""
                    className="bg-[#111]"
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm outline-none transition placeholder:text-white/20 focus:border-[#D4AF37]/50"
                />
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full resize-none rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm outline-none placeholder:text-white/20 focus:border-[#D4AF37]/50"
                />
          ...
          <section className="rounded-3xl border border-white/10 bg-white/[0.03] p-6">
            ...
            <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm outline-none focus:border-[#D4AF37]/50"
                >
                  <option
                    value="PERCENTAGE"
                    className="bg-[#111]"
            ...
            <button
              ...
              className="mt-4 rounded-xl border border-[#D4AF37]/20 bg-[#D4AF37]/5 px-4 py-2 text-xs font-semibold text-[#F5D76E] transition hover:bg-[#D4AF37]/10"
            >
              Calculate Deal Price
            </button>
            ...
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm uppercase outline-none placeholder:text-white/20 focus:border-[#D4AF37]/50"
                />
          ...
          <section className="rounded-3xl border border-white/10 bg-white/[0.03] p-6">
            ...
            <input
              ...
              className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm outline-none placeholder:text-white/20 focus:border-[#D4AF37]/50"
            />
          ...
          <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
            ...
            <button
              type="submit"
              disabled={saving}
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#D4AF37] px-7 py-3 text-sm font-bold text-black shadow-lg shadow-[#D4AF37]/10 transition hover:bg-[#E5C158] hover:shadow-[#D4AF37]/20 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {saving ? (
                <>
                  <Loader2
